...
public class RepositoryProdutoMockup {
    ...
    public RepositoryProdutoMockup() {        
        produtos.add(new Produto(ID++, "Banho", BigDecimal.valueOf(10.50)));  
        produtos.add(new Produto(ID++, "Tosa", BigDecimal.valueOf(15.23)));
        produtos.add(new Produto(ID++, "Vacina", BigDecimal.valueOf(15.23)));            
    }
